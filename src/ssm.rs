...
pub async fn fetch_ssm_parameters(ssm_client: Client, path_prefix: String) -> Result<HashMap<String, String>, SsmError> {
...
pub async fn fetch_ssm_parameter(ssm_client: Client, path: String) -> Result<Option<String>, SsmError> {
